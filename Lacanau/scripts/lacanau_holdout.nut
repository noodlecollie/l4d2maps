...
MapSpawns <- 
[
    // TODO: Some of these may be required to stop the mutation bringing up errors,
    // even if the entity groups they refer to are not present in the map
    // (for example, the tank manager and tank manholes). Investigate this.
    ...
    // the number of targets to consider for spawning at. (TODO: Confirm?)
...
stageDefaults <-
{
    ...
    callback = null,                                // TODO: What's this? I'm assuming it's a callback to fire when this stage is run? Check GameStartCB!
...
// MapSlowPoll() is called once every 2.5 seconds (TODO: Confirm?)
